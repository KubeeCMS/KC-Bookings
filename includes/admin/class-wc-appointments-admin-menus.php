...
class WC_Appointments_Admin_Menus {
	...
	public function buffer() {
		...
		if ( 'wc_appointment_page_add_appointment' == $screen->id ) {
			ob_start();
		}
	}
	...
	public function admin_menu() {
		$add_appointment_page = add_submenu_page( 'edit.php?post_type=wc_appointment', __( 'Add New', 'woocommerce-appointments' ), __( 'Add New', 'woocommerce-appointments' ), 'manage_appointments', 'add_appointment', array( $this, 'add_appointment_page' ) );
