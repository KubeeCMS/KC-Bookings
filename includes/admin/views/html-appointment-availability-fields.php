...
<tr data-id="<?php echo esc_attr( $availability_id ); ?>">
		...
		<div class="appointments-datetime-select-from">
			...
			<?php } else { ?>
				...
				<div class="from_date">
					...
					?>
					<input type="text" class="date-picker" name="wc_appointment_availability_from_date[]" value="<?php echo esc_attr( $from_date ); ?>" placeholder="yyyy-mm-dd" autocomplete="off" />
				</div>
				<div class="from_time">
					<?php
					$from_time = '';
	...
	<td class="range_to" style="<?php echo $is_rrule ? 'display:none;' : ''; ?>">
		<div class='appointments-datetime-select-to'>
			...
			<div class="to_date">
				...
				?>
				<input type="text" class="date-picker" name="wc_appointment_availability_to_date[]" value="<?php echo esc_attr( $to_date ); ?>" placeholder="yyyy-mm-dd" autocomplete="off" />
			</div>
	...
	<?php if ( 'product' === $get_current_screen->id ) { ?>
