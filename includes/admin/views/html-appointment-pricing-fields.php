		...
		<div class="appointments-datetime-select-from">
			<div class="select from_day_of_week">
				<select name="wc_appointment_pricing_from_day_of_week[]" class="day-of-week-picker">
					<?php foreach ( $intervals['days'] as $key => $label ) : ?>
						<option value="<?php echo esc_html( $key ); ?>" <?php selected( isset( $pricing['from'] ) && $pricing['from'] == $key, true ); ?>><?php echo esc_html( $label ); ?></option>
					<?php endforeach; ?>
				</select>
			</div>
			...
			<div class="from_date">
				...
				?>
				<input type="text" class="date-picker" name="wc_appointment_pricing_from_date[]" value="<?php echo esc_attr( $from_date ); ?>" placeholder="yyyy-mm-dd" autocomplete="off" />
			</div>
			<div class="from_time">
				<input
					type="time"
	...
	<td class="range_to">
		<div class='appointments-datetime-select-to'>
			...
			<div class="to_date">
				...
				?>
				<input type="text" class="date-picker" name="wc_appointment_pricing_to_date[]" value="<?php echo esc_attr( $to_date ); ?>" placeholder="yyyy-mm-dd" autocomplete="off" />
			</div>
