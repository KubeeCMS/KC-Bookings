...
$staff_product = isset( $user_product_id ) ? $user_product_id : 0;
...
$staff_base_cost  = isset( $staff_base_costs[ $user_id ] ) ? $staff_base_costs[ $user_id ] : '';
$staff_qtys       = $user_product->get_staff_qtys( 'edit' );
$staff_qty        = isset( $staff_qtys[ $user_id ] ) ? $staff_qtys[ $user_id ] : '';
?>
<tr>
	<td class="sort">&nbsp;</td>
