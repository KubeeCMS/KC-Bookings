<?php
/**
 * Plugin Name: KC Bookings & Reservations
 * Plugin URI: https://github.com/KubeeCMS/KC-Bookings/
 * Description: Setup appointable products KC Commerce ...
 * Version: 4.9.8
 * Tested up to: 5.3
...
if ( ! class_exists( 'WC_Appointments' ) ) :
	define( 'WC_APPOINTMENTS_VERSION', '4.9.8' );
		...
		public function includes() {
			...
			if ( version_compare( WC_VERSION, '3.0', '<' ) ) {
				...
				if ( ! class_exists( 'WC_DateTime' ) ) {
					include_once WC_APPOINTMENTS_ABSPATH . 'includes/compatibility/class-wc-datetime.php';
				}
			}
